 ...
 * <li> {@code setAt} : reset the element at a given position </li>
...
public interface List<T> {
    ...
    /**
     * Set the value at the position {@code idx}
     * @param idx the position of element to reset
     * @throws IndexOutOfBoundsException if {@code idx} is out of range
     */
    void setAt(int idx, T newElem);
    ...
    /**
     * Return the lenth of the largest primary cluster
     * @return the length of the largest primary cluster
     */
