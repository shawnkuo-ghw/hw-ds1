...
import ex04.classes.implementations.AttackStrategyImplementation;
...
public class AttackStrategyTest {
    ...
    public void unsuccessfulAttackTest_One() {
        ...
        assertEquals("[5, 20, 40]", w.toString());
    }
    ...
    public void unsuccessfulAttackTest_Two() {
        ...
        assertEquals("[50, 70, 80]", w.toString());
        assertTrue(w.repel(a));
        assertEquals(40, w.remainingPower());
        assertEquals("[10, 30]", w.toString());
    }
    ...
    public void unsuccessfulAttackTest_Three() {
        ...
        assertEquals("[10, 50, 100]", w.toString());
        assertTrue(w.repel(a));
