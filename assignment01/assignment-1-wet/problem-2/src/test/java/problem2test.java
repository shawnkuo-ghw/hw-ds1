...
public class problem2test {
    ...
    @Test
    public void sortPositiveTestOne() {
    ...
    public void sortPositiveTestTwo() {
        int[] A = new int[]{1,5,3,6,3,8,3,9,4,1,0,6,2,4,6,7};
        int[] expected = new int[]{0,1,1,2,3,3,3,4,4,5,6,6,6,7,8,9};
        problem2.sort(A);
        assertArrayEquals(expected, A);
    }

    public void sortPositiveTestThree() {
        int[] A = new int[]{1,5,3,6,3,8,9,4,1,0,6,2,2,4,6,7};
        int[] expected = new int[]{0,1,1,2,2,3,3,4,4,5,6,6,6,7,8,9};
        problem2.sort(A);
        assertArrayEquals(expected, A);
    }
